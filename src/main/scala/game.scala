...
object game extends App {
  ...
  def main(): Unit ={
    ...
    // var stdin_line = scala.io.StdIn.readLine()
    // var json_string:String = stdin_line

    // while (!stdin_line.contains('}')){
    //   stdin_line = scala.io.StdIn.readLine()
    //   json_string += stdin_line
    // }
    //board
    ...
    val gameBoard = json_string.parseJson.convertTo[Board]
